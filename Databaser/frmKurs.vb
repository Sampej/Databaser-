...
#End Region
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        mySqlCommand.CommandText = "INSERT INTO Kurs981219 (kursnamn) VALUES ('" & nyttKursNamn & "')"
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        mySqlCommand.CommandText = "SELECT * FROM Kurselev981219 WHERE kursnamn = '" & knamn & "'"
        ...
        If ds.Tables("Kurser").Rows.Count > 0 Then
            ...
            Exit Sub
        End If
        mySqlCommand.CommandText = "DELETE FROM Kurs981219 WHERE kursnamn = '" & ListBox1.Items(ListBox1.SelectedIndex).ToString() & "'"
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        mySqlCommand.CommandText = "UPDATE Kurs981219 SET kursnamn = '" & ListBox1.SelectedItem.ToString() & "' WHERE kursnamn = '" & nyttNamn & "'"

        mySqlCommand.ExecuteNonQuery()

        mySqlCommand.CommandText = "UPDATE Elev981219 SET kursnamn = '" & nyttNamn & "' WHERE kursnamn = '" & ListBox1.SelectedItem.ToString() & "'"
