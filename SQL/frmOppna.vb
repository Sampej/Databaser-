...
#End Region
    ...
    Private Sub uppdateraListan()
        ...
        mySqlCommand.CommandText = "SELECT * FROM Elev981219 ORDER BY efternamn"
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If ListBox1.SelectedIndex <> -1 Then
            mySqlConnection.Open()
            mySqlCommand.CommandText = "DELETE FROM Elev981219 WHERE pnr = '" & ListBox1.SelectedValue.ToString() & "'"

            mySqlCommand.ExecuteNonQuery()
            mySqlCommand.CommandText = "DELETE FROM KursElev981219 WHERE kursnamn = '" & ListBox1.SelectedValue.ToString() & "'"
