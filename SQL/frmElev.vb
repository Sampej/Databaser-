...
#End Region
    ...
    Private Sub hämtakurser()
        ...
        mySqlCommand.CommandText = "SELECT * FROM Kurs981219"
    ...
    Private Sub uppdateraelev(ByVal personnummer As String)
        ...
        mySqlConnection.open()
        mySqlCommand.CommandText = "SELECT * FROM KursElev981219 WHERE pnr = '" & personnummer & "'"
        ...
        mySqlCommand.CommandText = "SELECT * FROM Elev981219 WHERE pnr = '" & personnummer & "'"
        myAdapter = New SqlDataAdapter(mySqlCommand)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        mySqlConnection.open()
        mySqlCommand.CommandText = "SELECT * FROM Elev981219 WHERE pnr = '" & nyttPnr & "'"
        ...
        If Me.Owner.Text = "frmOppna" Then
            ...
            mySqlCommand.CommandText = "DELETE FROM Elev981219 WHERE pnr = '" & gammaltPnr & "'"

            mySqlCommand.ExecuteNonQuery()
            mySqlCommand.CommandText = "DELETE FROM KursElev981219 WHERE pnr = '" & gammaltPnr & "'"

            mySqlCommand.ExecuteNonQuery()

        End If
        mySqlCommand.CommandText = "INSERT INTO Elev981219 (pnr, fornamn, efternamn , ort) VALUES ('" & nyttPnr & "','" & TxtFor.Text & "', '" & txtEfter.Text & "', '" & txtOrt.Text & "')"
        ...
        For i = 0 To ListBox2.Items.Count - 1
            ...
            mySqlCommand.CommandText = "INSERT INTO KursElev981219 (pnr, kursnamn) VALUES ('" & nyttPnr & "', '" & ListBox2.Items.Item(i) & "')"
